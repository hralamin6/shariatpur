<nav x-cloak @click.outside="nav = false" class="md:block shadow-2xl bg-white overflow-y-hidden overflow-x-hidden inset-y-0 z-10 fixed md:relative flex-shrink-0 w-64 overflow-y-auto bg-white dark:bg-darkSidebar dark:scrollbar-thin-dark scrollbar-thin-light"
    ...
    <span class="w-10 h-10 rounded-full bg-purple-600 border dark:border-gray-600 shadow-xl overflow-hidden flex items-center justify-center">
        ...
        <div class="capitalize">
                ...
                <a href="{{route('app.categories')}}" wire:navigate class="navMenuLink items-center {{Route::is('app.categories')?'navActive':'navInactive'}}">
                    <i class='bx bxs-book text-xl {{Route::is('app.categories')?'bx-tada':''}}'></i><span class="">@lang('categories')</span>
                </a>
                <a href="{{route('app.posts')}}" wire:navigate class="navMenuLink items-center {{Route::is('app.posts')?'navActive':'navInactive'}}">
                    <i class='bx bxs-book text-xl {{Route::is('app.posts')?'bx-tada':''}}'></i><span class="">@lang('posts')</span>
                </a>
