<div x-data>
    ...
    <form wire:submit.prevent="login" class="bg-white dark:bg-darkBg shadow-lg rounded-lg p-6 max-w-md mx-auto space-y-4">
        <!-- Email Address -->
        <div>
            <x-input-label for="email" :value="__('Email')" class="text-gray-700 dark:text-gray-300"/>
            <input wire:model="email" id="email" class="block mt-1 w-full border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm px-4 py-2 bg-gray-100 dark:bg-darker focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-darker" type="email" name="email" required autofocus autocomplete="username"/>
        ...
        <div>
            ...
            <input wire:model="password" id="password" class="block mt-1 w-full border border-gray-300 dark:border-gray-700 rounded-lg shadow-sm px-4 py-2 bg-gray-100 dark:bg-darker focus:ring-indigo-500 focus:border-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-darker" type="password" name="password" required autocomplete="current-password"/>
        ...
        <div class="block mt-4">
            <label for="remember" class="inline-flex items-center text-gray-700 dark:text-gray-300">
                <input wire:model="remember" id="remember" type="checkbox" class="rounded border-gray-300 dark:border-gray-600 text-indigo-600 shadow-sm focus:ring-indigo-500 dark:focus:ring-indigo-600 dark:focus:ring-offset-darker">
